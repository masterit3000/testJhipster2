...
import tuantu.demo.jhip.config.audit.AuditEventConverter;
import tuantu.demo.jhip.domain.PersistentAuditEvent;
...
import static tuantu.demo.jhip.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
