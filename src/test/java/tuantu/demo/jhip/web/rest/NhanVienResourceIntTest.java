...
import tuantu.demo.jhip.TestJhipster2App;
...
import tuantu.demo.jhip.web.rest.errors.ExceptionTranslator;
...
import static tuantu.demo.jhip.web.rest.TestUtil.sameInstant;
import static tuantu.demo.jhip.web.rest.TestUtil.createFormattingConversionService;
...
public class NhanVienResourceIntTest {
    ...
    private static final String DEFAULT_TENDANGNHAP = "AAAAAAAAAA";
    private static final String UPDATED_TENDANGNHAP = "BBBBBBBBBB";
    ...
    public static NhanVien createEntity(EntityManager em) {
        NhanVien nhanVien = new NhanVien()
            .tendangnhap(DEFAULT_TENDANGNHAP)
    ...
    public void createNhanVien() throws Exception {
        ...
        assertThat(testNhanVien.getTendangnhap()).isEqualTo(DEFAULT_TENDANGNHAP);
        assertThat(testNhanVien.getMatkhau()).isEqualTo(DEFAULT_MATKHAU);
    ...
    @Test
    @Transactional
    public void checkTendangnhapIsRequired() throws Exception {
    ...
    @Test
    @Transactional
    public void checkMatkhauIsRequired() throws Exception {
        int databaseSizeBeforeTest = nhanVienRepository.findAll().size();
        // set the field null
    ...
    public void getAllNhanViens() throws Exception {
        ...
        restNhanVienMockMvc.perform(get("/api/nhan-viens?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tendangnhap").value(hasItem(DEFAULT_TENDANGNHAP.toString())))
            .andExpect(jsonPath("$.[*].matkhau").value(hasItem(DEFAULT_MATKHAU.toString())))
    ...
    public void getNhanVien() throws Exception {
        ...
        restNhanVienMockMvc.perform(get("/api/nhan-viens/{id}", nhanVien.getId()))
            ...
            .andExpect(jsonPath("$.tendangnhap").value(DEFAULT_TENDANGNHAP.toString()))
            .andExpect(jsonPath("$.matkhau").value(DEFAULT_MATKHAU.toString()))
    ...
    public void updateNhanVien() throws Exception {
        ...
        updatedNhanVien
            .tendangnhap(UPDATED_TENDANGNHAP)
        ...
        NhanVien testNhanVien = nhanVienList.get(nhanVienList.size() - 1);
        assertThat(testNhanVien.getTendangnhap()).isEqualTo(UPDATED_TENDANGNHAP);
        assertThat(testNhanVien.getMatkhau()).isEqualTo(UPDATED_MATKHAU);
