...
public class LichSuDongTienResource {
    ...
    @Timed
    public ResponseEntity<List<LichSuDongTienDTO>> getAllLichSuDongTiens(Pageable pageable) {
        log.debug("REST request to get a page of LichSuDongTiens");
        Page<LichSuDongTienDTO> page = lichSuDongTienService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/lich-su-dong-tiens");
